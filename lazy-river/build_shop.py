...
# (slug, filename, nav label, title, tagline, package name, package price, sell copy paragraphs)
USE_CASES = [
...
def build_use_case(slug, filename, nav_label, title, tagline, pkg_name, pkg_price, paragraphs):
...
for slug, filename, nav_label, title, tagline, pkg_name, pkg_price, paragraphs in USE_CASES:
    build_use_case(slug, filename, nav_label, title, tagline, pkg_name, pkg_price, paragraphs)
...
hub_content = f"""
    ...
    Below: ten occasions we've already imagined for you.</p>
    </font>
    ...
    <table width="100%" border="3" cellpadding="8" cellspacing="0" bgcolor="#003366" style="border-color:#00ffff;">
      ...
      <tr>
        <td valign="top" width="33%"><font color="#00ffff"><b>1. You Pick a Package</b></font><br><font color="#fff" size="2">Browse the ten occasion pages above and choose the one closest to your event (or closest to your vibe, we won't check).</font></td>
...
print("done: shop.html + 10 use-case pages")
